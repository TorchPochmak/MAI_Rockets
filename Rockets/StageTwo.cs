...
namespace Rockets
{
    class StageTwo : Stages
    {
        ...
        public StageTwo()
        {
            ...
            Fmin = 247e+03;  // Тяга двигателя второй ступени (Блок А) на уровне моря
            Fmax = 260e+03; // Тяга двигателя второй ступени в вакууме, Н
            angle = 40; // Конечный угол поворота ракеты относительно вертикальной оси за время работы второй ступени, град
            k = (35572 - 6322) / 330; // Расход массы второй ступени, кг/с
            M = 35572 - 65*k; // Масса ракеты с космическим кораблём после отделения первой ступени, кг
